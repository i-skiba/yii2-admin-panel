...
class Crud extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'text_input' => Yii::t('common', 'Текстовое поле'),
            'text_area' => Yii::t('common', 'Многострочное текстовое поле'),
            'mask' => Yii::t('common', 'Маска'),
            'editor' => Yii::t('common', 'Редактор'),
            'checkbox_standart' => Yii::t('common', 'Чекбокс стандартный'),
            'checkbox_switch' => Yii::t('common', 'Чекбокс хитрый'),
            'date_picker' => Yii::t('common', 'Выбор даты'),
            'time_picker' => Yii::t('common', 'Выбор времени'),
            'dropdown' => Yii::t('common', 'Выпадающее меню'),
            'dropdown_root' => Yii::t('common', 'Управляющий элемент'),
            'dropdown_depend' => Yii::t('common', 'Зависимые элементы 1'),
            'dropdown_depend_2' => Yii::t('common', 'Зависимый элемент 2'),
            'radio' => Yii::t('common', 'Набор радиобатонов'),
